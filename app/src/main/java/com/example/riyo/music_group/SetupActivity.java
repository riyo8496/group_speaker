...
public  abstract class SetupActivity extends AppCompatActivity
    ...
    public SetupActivity(String tag)
    {
        TAG = tag;
    }
    ...
    private final ConnectionLifecycleCallback mConnectionLifecycleCallback =
            new ConnectionLifecycleCallback() {
                ...
                public void onConnectionInitiated(String endpointId, ConnectionInfo connectionInfo) {
                    ...
                    SetupActivity.this.onConnectionInitiated(endpoint, connectionInfo);
                }
                    ...
                    if (!result.getStatus().isSuccess()) {
                        logW(
                                String.format(
                                        ...
                                        SetupActivity.toString(result.getStatus())));
    ...
    private final PayloadCallback mPayloadCallback =
            new PayloadCallback() {
                ...
                public void onPayloadTransferUpdate(String endpointId, PayloadTransferUpdate update) {
                    ...
                    onPayloadUpdate(mEstablishedConnections.get(endpointId), update);
                }
            };
    ...
    private void createGoogleApiClient() {
        if (mGoogleApiClient == null) {
            ...
            //PersistentResource.getInstance().setGoogleApiClient(mGoogleApiClient);
        }
    }
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        logW(
                String.format(
                        ...
                        SetupActivity.toString(new Status(connectionResult.getErrorCode()))));
    }
                        ...
                        new ResultCallback<Connections.StartAdvertisingResult>() {
                            ...
                            public void onResult(@NonNull Connections.StartAdvertisingResult result) {
                                if (result.getStatus().isSuccess()) {
                                    ...
                                    Toast.makeText(getApplicationContext(), "started advertisement", Toast.LENGTH_LONG).show();
                                    ...
                                    logD(
                                            String.format(
                                                    ...
                                                    SetupActivity.toString(result.getStatus())));
                                    Toast.makeText(getApplicationContext(), "advertisement failed", Toast.LENGTH_LONG).show();
                                    onAdvertisingFailed();
                                }
                            }
                        });
                        ...
                        new ResultCallback<Status>() {
                            ...
                            public void onResult(@NonNull Status status) {
                                if (!status.isSuccess()) {
                                    logW(
                                            String.format(
                                                    "acceptConnection failed. %s", SetupActivity.toString(status)));
                                }
                            }
                        });
    }
                        ...
                        new ResultCallback<Status>() {
                            ...
                            public void onResult(@NonNull Status status) {
                                if (!status.isSuccess()) {
                                    logW(
                                            String.format(
                                                    "rejectConnection failed. %s", SetupActivity.toString(status)));
                                }
                            }
                        });
    }
                        ...
                        new ResultCallback<Status>() {
                            ...
                            public void onResult(@NonNull Status status) {
                                if (!status.isSuccess()) {
                                    logW(
                                            String.format(
                                                    "requestConnection failed. %s", SetupActivity.toString(status)));
                                    mIsConnecting = false;
    ...
    protected List<Endpoint> getDiscoveredEndpoints() {
     ...
     * either on incoming or outgoing payload
     * override this method to perform corresponding task
     */
